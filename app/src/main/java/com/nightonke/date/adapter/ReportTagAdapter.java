...
public class ReportTagAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        icon.setImageDrawable(StatementDateUtil.getInstance().GetTagIconDrawable((int)tagExpense.get(position + 1)[2]));
        name.setText(StatementDateUtil.getInstance().GetTagName((int)tagExpense.get(position + 1)[2]) + StatementDateUtil.getInstance().GetPurePercentString(tagExpense.get(position + 1)[1] * 100));
        expense.setText(StatementDateUtil.getInstance().GetInMoney((int)tagExpense.get(position + 1)[0]));
        records.setText(StatementDateUtil.getInstance().GetInRecords((int)tagExpense.get(position + 1)[3]));
