...
public class DrawerMonthViewRecyclerViewAdapter
    ...
    public void onBindViewHolder(final viewHolder holder, final int position) {
        holder.month.setText(StatementDateUtil.GetMonthShort(months.get(position) + 1));
        holder.month.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);

        holder.year.setText(years.get(position) + "");
        holder.year.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);

        holder.sum.setText(StatementDateUtil.getInstance().GetInRecords(records.get(position)));
        holder.sum.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);

        holder.money.setText(StatementDateUtil.getInstance().GetInMoney((int) (double) (expenses.get(position))));
        holder.money.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
    }
