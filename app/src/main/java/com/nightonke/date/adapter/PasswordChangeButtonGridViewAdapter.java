...
public class PasswordChangeButtonGridViewAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return StatementDateUtil.BUTTONS.length;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == 11) {
            holder.tv.setTypeface(StatementDateUtil.typefaceLatoHairline);
            ...
            holder.tv.setTypeface(StatementDateUtil.typefaceLatoHairline);
            holder.tv.setText(StatementDateUtil.BUTTONS[position]);
            holder.ml.setRippleDelayClick(false);
        }

        holder.ml.setRippleDuration(300);
        holder.fl.setBackgroundColor(
                StatementDateUtil.getAlphaColor(SettingManager.getInstance().getRemindColor()));
        ...
        holder.fl.setBackgroundColor(StatementDateUtil.getAlphaColor(StatementDateUtil.MY_BLUE));
        holder.ml.setRippleColor(StatementDateUtil.MY_BLUE);
        holder.iv.setColor(StatementDateUtil.MY_BLUE);
        holder.tv.setTextColor(StatementDateUtil.MY_BLUE);
