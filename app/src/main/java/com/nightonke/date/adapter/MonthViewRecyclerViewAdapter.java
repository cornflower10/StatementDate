...
public class MonthViewRecyclerViewAdapter
    ...
    private List<StatementDateRecord> list;
    ...
    private ArrayList<Map<Integer, ArrayList<StatementDateRecord>>> ExpanseList;
    ...
    public MonthViewRecyclerViewAdapter(
        ...
        if (!IS_EMPTY) {
            ...
            Map<Integer, ArrayList<StatementDateRecord>> Expanse;
            ...
            // for this month
            dateStringList.add(StatementDateUtil.GetMonthShort(nowMonth + 1) + " " + nowYear);
            dateShownStringList.add(" in " + StatementDateUtil.MONTHS_SHORT[nowMonth + 1] + " " + nowYear);
            ...
            for (StatementDateRecord coCoinRecord : list) {
            ...
            while (!now.after(monthEnd)) {
                Calendar leftWeekRange = StatementDateUtil.GetThisWeekLeftRange(now);
                Calendar rightWeekRange = StatementDateUtil.GetThisWeekRightRange(now);
                Calendar rightShownWeekRange = StatementDateUtil.GetThisWeekRightShownRange(now);
                String dateString = StatementDateUtil.GetMonthShort(leftWeekRange.get(Calendar.MONTH) + 1) + " " +
                        leftWeekRange.get(Calendar.DAY_OF_MONTH) + " " +
                        leftWeekRange.get(Calendar.YEAR) + " - " +
                        StatementDateUtil.GetMonthShort(rightShownWeekRange.get(Calendar.MONTH) + 1) + " " +
                ...
                dateShownStringList.add(" from " +
                        StatementDateUtil.GetMonthShort(leftWeekRange.get(Calendar.MONTH) + 1) + " " +
                ...
                now = StatementDateUtil.GetNextWeekLeftRange(now);
            }
        }
    }
    ...
    public void onBindViewHolder(final viewHolder holder, final int position) {
        ...
        if (IS_EMPTY) {
            ...
            holder.expanseSum.setText(StatementDateUtil.GetInMoney((int) (double) SumList.get(position)));

            holder.date.setTypeface(StatementDateUtil.GetTypeface());
            holder.expanseSum.setTypeface(StatementDateUtil.typefaceLatoLight);

            holder.tags.setTypeface(StatementDateUtil.typefaceLatoLight);
            if ("zh".equals(StatementDateUtil.GetLanguage())) {
                holder.tags.setText(" ● " + records + mContext.getResources().getString(R.string.report_view_records) + tags + mContext.getResources().getString(R.string.report_view_tags));
            } else {
                holder.tags.setText(" ● " + records + " " + mContext.getResources().getString(R.string.report_view_records) + " " + tags + " " + mContext.getResources().getString(R.string.report_view_tags));
            }
            ...
            if (SumList.get(position).equals(Double.valueOf(0))) {
                ...
                holder.emptyTip.setTypeface(StatementDateUtil.typefaceLatoLight);
            } else {
                ...
                public void onClick(View v) {
                    if ("zh".equals(StatementDateUtil.GetLanguage())) {
                        dialogTitle = mContext.getResources().getString(R.string.in)
                                ...
                                " " + StatementDateUtil.GetSpendString((int) (double) SumList.get(position));
                    } else {
                        dialogTitle = StatementDateUtil.GetSpendString((int) (double) SumList.get(position)) +
        ...
        public void onValueSelected(int i, SliceValue sliceValue) {
            ...
            Snackbar snackbar =
                    Snackbar
                            ...
                            .margin(15, 15)
                            .backgroundDrawable(StatementDateUtil.GetSnackBarBackground(fragmentPosition - 2))
                            .text(text)
                            ...
                            .actionListener(new ActionClickListener() {
                                ...
                                public void onActionClicked(Snackbar snackbar) {
                                    List<StatementDateRecord> shownCoCoinRecords
