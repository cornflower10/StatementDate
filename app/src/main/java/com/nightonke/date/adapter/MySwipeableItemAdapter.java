...
import com.nightonke.date.ui.SwipeableItemOnClickListener;
...
public class MySwipeableItemAdapter
    ...
    private List<StatementDateRecord> records;
    ...
    public MySwipeableItemAdapter(Context inContext, List<StatementDateRecord> records, final OnItemDeleteListener onItemDeleteListener, OnItemClickListener onItemClickListener) {
        mContext = inContext;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        StatementDateRecord record = records.get(tPosition);
        holder.tagImage.setImageResource(
                StatementDateUtil.GetTagIcon(record.getTag()));
        ...
        holder.money.setTextColor(ContextCompat.getColor(mContext, R.color.my_blue));
    ...
    public static class SwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        protected void onPerformAction() {
            ...
            StatementDateUtil.backupCoCoinRecord
