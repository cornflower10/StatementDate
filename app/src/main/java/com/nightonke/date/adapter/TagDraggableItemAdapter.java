...
public class TagDraggableItemAdapter
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.tagImage.setImageResource(StatementDateUtil.GetTagIcon(tags.get(position).getId()));
        holder.tagName.setText(StatementDateUtil.GetTagName(tags.get(position).getId()));
        holder.tagName.setTypeface(StatementDateUtil.typefaceLatoLight);
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0)) {
            ...
            if ((dragState & Draggable.STATE_FLAG_IS_ACTIVE) != 0) {
                ...
                StatementDateUtil.clearState(holder.mContainer.getForeground());
