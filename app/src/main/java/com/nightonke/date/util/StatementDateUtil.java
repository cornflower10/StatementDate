...
import com.nightonke.date.db.DBHelper;
...
public class StatementDateUtil {
    ...
    public static StatementDateRecord backupCoCoinRecord;
...
//        if (file.exists()) file.delete();
    ...
    private static StatementDateUtil ourInstance = new StatementDateUtil();

    public static StatementDateUtil getInstance() {
        if (ourInstance == null || typefaceLatoLight == null || typefaceLatoHairline == null) {
            ourInstance = new StatementDateUtil();
            init(CoCoinApplication.getAppContext());
        }
        return ourInstance;
    }

    private StatementDateUtil() {
    }
}
