...
import com.nightonke.date.adapter.HelpFragmentAdapter;
...
public class AboutActivity extends AppCompatActivity implements HelpFeedbackFragment.OnTextChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.getPagerTitleStrip().setTypeface(StatementDateUtil.getInstance().typefaceLatoLight, Typeface.NORMAL);
        ...
        adapter = new HelpFragmentAdapter(getSupportFragmentManager(), 2,mContext);
        ...
        mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
            ...
            public HeaderDesign getHeaderDesign(int page) {
                return HeaderDesign.fromColorAndDrawable(
                        ContextCompat.getColor(AboutActivity.this, R.color.my_blue),
                        ContextCompat.getDrawable(
                                AboutActivity.this, R.drawable.cocoin_blue_bg));
            }
        });
