...
import com.nightonke.date.adapter.DrawerTagChooseGridViewAdapter;
import com.nightonke.saver.BuildConfig;
import com.nightonke.saver.R;
import com.nightonke.date.adapter.TagViewFragmentAdapter;
...
public class AccountBookTagViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.getPagerTitleStrip().setTypeface(StatementDateUtil.typefaceLatoLight, Typeface.NORMAL);
        ...
        tagModeAdapter = new TagViewFragmentAdapter(getSupportFragmentManager(),mContext);
            ...
            mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
                ...
                public HeaderDesign getHeaderDesign(int page) {
                    return HeaderDesign.fromColorAndUrl(
                            StatementDateUtil.GetTagColor(RecordManager.TAGS.get(page).getId()),
                            StatementDateUtil.GetTagUrl(RecordManager.TAGS.get(page).getId()));
                }
            });
        } else {
            mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
