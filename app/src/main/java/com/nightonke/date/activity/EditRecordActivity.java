...
public class EditRecordActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            StatementDateUtil.editRecordPosition = RecordManager.SELECTED_RECORDS.size() - 1 - position;
        } else {
    ...
    private void buttonClickOperation(boolean longClick, int position) {
        ...
        if (CoCoinFragmentManager.editRecordActivityEditMoneyFragment.getNumberText().toString().equals("0")
            ...
            if (StatementDateUtil.ClickButtonDelete(position)
                ...
                CoCoinFragmentManager.editRecordActivityEditMoneyFragment.setNumberText(StatementDateUtil.BUTTONS[position]);
            }
        } else {
            if (StatementDateUtil.ClickButtonDelete(position)) {
                if (longClick) {
                    ...
                    CoCoinFragmentManager.editRecordActivityEditMoneyFragment.setHelpText(
                            StatementDateUtil.FLOATINGLABELS[CoCoinFragmentManager.editRecordActivityEditMoneyFragment
                ...
                if (FIRST_EDIT) {
                    ...
                    CoCoinFragmentManager.editRecordActivityEditMoneyFragment
                            .setNumberText(CoCoinFragmentManager.editRecordActivityEditMoneyFragment
                                    .getNumberText().toString() + StatementDateUtil.BUTTONS[position]);
                }
            }
        }
        CoCoinFragmentManager.editRecordActivityEditMoneyFragment.setHelpText(StatementDateUtil.FLOATINGLABELS[
