...
import com.nightonke.date.adapter.PasswordChangeButtonGridViewAdapter;
import com.nightonke.date.adapter.PasswordChangeFragmentAdapter;
...
public class ShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int iconOffsetX = StatementDateUtil.getInstance().dpToPx(28);
        int iconOffsetY = StatementDateUtil.getInstance().dpToPx(28);
        ...
        ((TextView)findViewById(R.id.text_0)).setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        sc7.startToPosition(size.x / 2 - StatementDateUtil.getInstance().dpToPx(140), size.y * 8 / 9 - StatementDateUtil.getInstance().dpToPx(140) + size.y);
        ...
        ((TextView)findViewById(R.id.text_1)).setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        sc9.startToPosition(size.x / 2 - StatementDateUtil.getInstance().dpToPx(100) + size.x, size.y / 7);
        ...
        sc10.startToPosition(size.x / 2 - size.x, size.y * 6 / 7 - StatementDateUtil.getInstance().dpToPx(100));
        ...
        ((TextView)findViewById(R.id.text_2)).setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        ((TextView)findViewById(R.id.text_3)).setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        viewPagerLayoutParams.topMargin
                                = getStatusBarHeight() + StatementDateUtil.getToolBarHeight(mContext) / 2;
        ...
        switch (CURRENT_STATE) {
            case NEW_PASSWORD:
                if (StatementDateUtil.ClickButtonDelete(position)) {
                    ...
                    newPassword += StatementDateUtil.BUTTONS[position];
            ...
            case PASSWORD_AGAIN:
                if (StatementDateUtil.ClickButtonDelete(position)) {
                    ...
                    againPassword += StatementDateUtil.BUTTONS[position];
