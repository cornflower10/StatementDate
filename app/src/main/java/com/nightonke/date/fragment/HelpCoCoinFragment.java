...
public class HelpCoCoinFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        int width = StatementDateUtil.getInstance().GetScreenWidth(mContext) - StatementDateUtil.getInstance().dpToPx(20);
        ...
        textView2.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView3.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView4.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView5.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView6.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView7.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView8.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView9.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
        ...
        textView10.setTypeface(StatementDateUtil.getInstance().typefaceLatoLight);
