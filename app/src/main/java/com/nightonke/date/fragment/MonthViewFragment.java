...
import com.nightonke.date.adapter.MonthViewRecyclerViewAdapter;
...
public class MonthViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!IS_EMPTY) {
            ...
            Calendar leftRange = StatementDateUtil.GetThisWeekLeftRange(monthStart);
            Calendar rightRange = StatementDateUtil.GetThisWeekRightRange(monthEnd);
