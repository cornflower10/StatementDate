...
import com.nightonke.date.adapter.RecordCheckDialogRecyclerViewAdapter;
...
public class RecordCheckDialogFragment extends DialogFragment implements RecordCheckDialogRecyclerViewAdapter.OnItemClickListener {
    ...
    public RecordCheckDialogFragment(Context context, List<StatementDateRecord> list, String title) {
        this.list = list;
        this.title = title;
        mContext = context;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alert.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                btnPositive.setTypeface(StatementDateUtil.typefaceLatoLight);
            }
        });
    ...
    public void onItemClick(View view, int position) {
        ...
        dialog = new MaterialDialog.Builder(mContext)
                .icon(StatementDateUtil.GetTagIconDrawable(list.get(position).getTag()))
        ...
        date.setText(StatementDateUtil.GetCalendarStringRecordCheckDialog(mContext, list.get(position).getCalendar()));
    }
}
